...
public class Inspector : Widget
{
    ...
    void UpdateControlSheet()
    {
        ...
        // Mesh Resolution
        // controlSheet.AddRow( serializedObject.GetProperty( nameof( Terrain.TerrainSize ) ) );
        // controlSheet.AddRow( serializedObject.GetProperty( nameof( Terrain.TerrainHeight ) ) );
    }
